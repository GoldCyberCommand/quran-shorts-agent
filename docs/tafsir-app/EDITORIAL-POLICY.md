...
- Not a position in an intra-Muslim polemic. Sunni classical and modern scholarship is
  the declared scope (see PLAN.md §2), stated plainly so a reader knows what they are
  reading — not smuggled in as neutrality.
